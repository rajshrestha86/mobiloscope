    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "Cannot create a Socket for Connection", Toast.LENGTH_SHORT ).show();
            }
            mmSocket = tmp;
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Data can't be received due to Internal Error.", Toast.LENGTH_SHORT).show();
                    break;
                }
