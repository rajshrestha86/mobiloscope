...
public class ohmMeter extends Activity {
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            TextView disp=(TextView) findViewById(R.id.ohmMeasure);

            if(writeMessage.matches("[0-9]+"))
            {
              disp.setText(writeMessage);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ohm_meter);
